package com.fufu.ragserver.config;
...
public class RagFileProperties
{
    ...
    public String getOcrDataPath() { return ocrDataPath; }
    public void setOcrDataPath(String ocrDataPath) { this.ocrDataPath = ocrDataPath; }
