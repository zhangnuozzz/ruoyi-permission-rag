...
public class RagFileController
{
    ...
    public RagFileController(IRagFileProcessService ragFileProcessService,
            SysRagFileMapper sysRagFileMapper,
    ...
    {
        return AjaxResult.success(sysRagFileMapper.selectSysRagFileList());
    }
