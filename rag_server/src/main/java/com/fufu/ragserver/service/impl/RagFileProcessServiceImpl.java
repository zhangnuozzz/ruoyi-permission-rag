...
import com.fufu.ragserver.service.RagFileTextExtractionService;
...
public class RagFileProcessServiceImpl implements IRagFileProcessService
{
    ...
    private final RagFileTextExtractionService ragFileTextExtractionService;
    ...
    public RagFileProcessServiceImpl(SysRagFileMapper sysRagFileMapper,
            ...
            RagFileTextExtractionService ragFileTextExtractionService)
    {
        ...
        this.ragFileTextExtractionService = ragFileTextExtractionService;
    }
            ...
            UploadUserContext userContext) throws Exception
    {
        ...
        RagFileTextExtractionResult extractionResult = ragFileTextExtractionService.extract(fileName,
            file.getContentType(), rawContent);
        List<RagFileChunk> chunks = langChain4jDocumentChunkService.split(fileId, extractionResult.getText(), securityLevel,
        ...
        result.setFileType(extractionResult.getFileType());
        result.setParseMethod(extractionResult.getParseMethod());
